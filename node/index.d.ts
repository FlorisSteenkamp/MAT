...
import { getClosestBoundaryPoint, closestPointOnBezier } from './src/mat/get-closest-boundary-point';
import * as Svg from './src/svg/svg';
export { Mat, PointOnShape, Curve, Loop, CpNode, Circle, ContactPoint, BezierPiece, findMat, toScaleAxis, toEnhancedScaleAxis, toSpectrumScaleAxis, trimMat, smoothen, getVerticesAsArray, getBranches, traverseEdges, MatDebug, Svg, getPathsFromStr, DebugElemType, IDrawElemFunctions, CpNodeForDebugging, ITiming, getClosestBoundaryPoint, closestPointOnBezier };
