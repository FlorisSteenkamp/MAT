...
/** @private */
declare type Edge = 'prev' | 'next' | 'prevOnCircle' | 'nextOnCircle';
/**
...
declare class CpNode {
     ...
     * maximal disk.
     */
    constructor(cp: ContactPoint, isHoleClosing: boolean, isIntersection: boolean, prev?: CpNode, next?: CpNode, prevOnCircle?: CpNode, nextOnCircle?: CpNode, matCurveToNextVertex?: number[][]);
    /**
     * Primarily for internal use.
     *
