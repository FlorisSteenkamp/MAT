...
function getBeziersFromSvgElem(elem) {
    ...
    function pushBezier(arr, ps_, j) {
        ...
        let ds = [
            [
                0,
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[0], ps_[1]),
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[0], ps_[2]),
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[0], ps_[3])
            ],
            [
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[1], ps_[0]),
                0,
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[1], ps_[2]),
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[1], ps_[3]),
            ],
            [
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[2], ps_[0]),
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[2], ps_[1]),
                0,
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[2], ps_[3]),
            ],
            [
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[3], ps_[0]),
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[3], ps_[1]),
                flo_vector2d_1.default.manhattanDistanceBetween(ps_[3], ps_[2]),
                0,
            ]
        ];
        let ps = ps_;
        ...
        if (ds[0][1] < DELTA && ds[1][2] < DELTA ||
            ...
            ps = [
                ps_[0],
                flo_vector2d_1.default.interpolate(ps_[0], ps_[3], 1 / 3),
                flo_vector2d_1.default.interpolate(ps_[0], ps_[3], 2 / 3),
                ps_[3]
            ];
        }
 ...
 * @returns {string}
 */
function getPathStrFromBeziers(beziers, decimalPlaces = 10) {
