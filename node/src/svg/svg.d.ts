...
export { getMinYPos, getPathsFromStr, getPathsFromSvgPathElem, getLoopBounds, isPathPositivelyOrientated, getCurvatureAtInterface, simplifyPaths, circleToCubicBeziers, beziersToSvgPathStr, getShapeBounds, getShapesBounds };
