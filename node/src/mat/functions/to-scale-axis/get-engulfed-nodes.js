 ...
 */
function getEngulfedNodes(s, tree, circle) {
    ...
    function cullBranch5(tree) {
        ...
        circles.forEach(function (vertex, key) {
            let c2 = circle_1.Circle.scale(vertex.circle, s);
            if (circle_1.Circle.engulfsCircle(c1, c2)) {
                cullNodes.add(vertex);
                circles.delete(key);
            }
        });
    }
...
exports.getEngulfedNodes = getEngulfedNodes;
