 ...
 * tolerances.
 */
declare function add2Prong(cpGraphs: Map<Loop, LlRbTree<CpNode>>, circle: Circle, posSource: PointOnShape, posAntipode: PointOnShape, holeClosing: boolean, extreme: number): CpNode;
export { add2Prong };
