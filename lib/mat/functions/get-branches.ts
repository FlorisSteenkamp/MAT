 ...
 * @param mat
 */
function getBranches(mat: MatTree) {
	...
	function g(matNode: MatNode, priorNode: MatNode, depth: number) {
 ...
 */
function traverseSingleBranch(matNode: MatNode, branchIndx: number) {
